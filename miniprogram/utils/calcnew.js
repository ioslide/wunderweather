...
function computeSunRiseSunSet(Latitude, Longitude, TimeZone) {
  ...
  if (Math.abs(SC) <= 1) {
    ...
    var strSunSetHour = transformedSunSet.getHours();
    var strSunRiseHour = transformedSunRise.getHours();
  ...
  retVal.strSunSetHour = strSunSetHour;
  retVal.strSunRiseHour = strSunRiseHour;
