var e = requirePlugin("chatRobot"), t = require("../base/date.js"), i = require("../base/weather.js");
...
Component({
    ...
    lifetimes: {
        ready: function() {
            ...
            var e = this.properties.msg, r = e.docs, s = [], a = {}, o = "";
            this.properties.msg && this.properties.msg.res && this.properties.msg.res.slots_info && 0 !== this.properties.msg.res.slots_info.length && (o = JSON.parse(this.properties.msg.res.slots_info[0].slot_value).date);
            for (var n = 1; n <= 6; n++) s.push(r.data[n]);
            for (var m = 0; m < s.length; m++) if (s[m].dateTime = t.dateTimeFormat(s[m].date), 
            s[m].week = t.date2Week(s[m].date), s[m].picture = i.chinese2letter(s[m].condition), 
            o === s[m].date) {
                a.dateTime = t.dateTimeFormat(s[m].date), a.week = t.date2Week(s[m].date), a.picture = i.chinese2letter(s[m].condition), 
            ...
            var d = a.min_tp, c = a.max_tp, h = a.tp, g = a.dateTime, w = a.week, l = a.picture, u = a.condition;
            this.setData({
                weatherDis: e,
                weatherArray: s,
                dateTime: g,
