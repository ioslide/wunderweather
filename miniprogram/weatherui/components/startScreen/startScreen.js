...
create.Component(store, {
  ...
  methods: {
    ...
    screenFadeOut() {
      ...
      const  poetryScreenFadeOut = async () =>{
        await poetryFadeOut()
        await startScreenFadeOut()
      }
    ...
    onAuthFinalScreen() {
      ...
      const authFinalStepLeaf = () => {
          t.animate('#leaf', [{
              translate3d: [windowWidth * 2, 0, 0],
              rotate3d: [0, 0, 0.6, 45],
              scale: [0.7],
              ease: 'ease-in-out'
            },
            {
              translate3d: [windowWidth * 2.7, 250, 0],
              rotate3d: [0, 0, -1, 45],
              scale: [0.7],
              ease: 'ease-in-out'
            }
      ...
      const authFirstStepLeaf = () => {
        wx.createSelectorQuery().in(this).select('#authScreenStepContent').boundingClientRect(function (rect) {
          ...
          t.animate('#leaf', [{
            ...
            {
              translate3d: [windowWidth, -rect.top, 0],
              rotate3d: [0, 10, -1, 45],
              scale: [0.3],
              ease: 'ease-in-out'
            },
    ...
    resaveNextPoetryContent() {
      ...
      poetry.load(
        result => {
          ...
          log(`[resaveNextPoetryContent] => poetryData =>`, poetryData)
